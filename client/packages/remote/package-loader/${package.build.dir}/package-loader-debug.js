...
Ext.define('Ext.package.Entry', {count:0, loaded:false, constructor:function(name) {
  var me = this;
  me.packageName = name;
...
Ext.define('Ext.Package', {requires:['Ext.package.Entry'], singleton:true, _entryMap:{}, _usesMap:null, _packagesMap:null, _loadQueue:[], _loading:false, getPackages:function() {
  ...
  var me = this, queue = me._loadQueue, next = queue.shift();
  if (next) {
    me._loading = true;
    next.beginLoad();
  ...
  var me = this, entry = me.getEntry(packageName);
  entry.load(scripts);
}, getEntry:function(pkgName) {
  var entryMap = this._entryMap, entry = entryMap[pkgName];
  if (!entry) {
